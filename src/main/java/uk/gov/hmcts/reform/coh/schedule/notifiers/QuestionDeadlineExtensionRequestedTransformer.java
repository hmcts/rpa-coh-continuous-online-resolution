...
import static uk.gov.hmcts.reform.coh.events.EventTypes.QUESTION_DEADLINE_EXTENDED;
import static uk.gov.hmcts.reform.coh.events.EventTypes.QUESTION_ROUND_ISSUED;

public class QuestionDeadlineExtensionRequestedTransformer implements EventTransformer<OnlineHearing> {
    ...
    public NotificationRequest transform(SessionEventType sessionEventType, OnlineHearing onlineHearing) {
        ...
        request.setEventType(QUESTION_DEADLINE_EXTENDED.getEventType());
