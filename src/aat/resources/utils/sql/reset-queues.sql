...
UPDATE public.session_event
SET retries=0, forwarding_state_id=(SELECT forwarding_state_id FROM public.session_event_forwarding_state WHERE forwarding_state_name IN ('event_forwarding_pending'))
