Feature: Online hearing filter feature
  ...
  Scenario: Search for an online hearing by case id
    When a get request is sent to ' "/continuous-online-hearings?case_id=case_126"' for the online hearing
    Then the response code is 200
    And the response contains 1 online hearings
    And the response contains online hearing with case 'case_126'
  ...
  Scenario: Search for multiple online hearings by case id
    ...
    When a get request is sent to ' "/continuous-online-hearings?case_id=case_126&case_id=case_456"' for the online hearing
  ...
  Scenario: Search for non-existent state
    And a get request is sent to ' "/continuous-online-hearings?case_id=case_126"' for the online hearing
    And the response contains 1 online hearings
    When a get request is sent to ' "/continuous-online-hearings?case_id=case_126&state=foo"' for the online hearing
    Then the response contains 0 online hearings

  Scenario: Search for online hearing by case id and state
    When a get request is sent to ' "/continuous-online-hearings?case_id=case_126&state=continuous_online_hearing_started"' for the online hearing
