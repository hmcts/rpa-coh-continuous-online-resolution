...
public class ApiSteps {
    ...
    @Given("^set the 'external_id' to 'test_externalId(\\d+)'$")
    public void set_the_external_id_to_test_externalId(int arg1) throws Throwable {
    ...
    public void the_response_contains_the_following_text(String arg1) throws Throwable {
